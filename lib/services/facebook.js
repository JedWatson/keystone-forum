...
exports.authenticateUser = function(req, res, next, callback)
{
	...
	var data = {
		...
		sydjsUser: false // KeystoneJS Forum user
	}
	...
	var createSydjsUser = function() {
		...
		console.log('[services.facebook] - Creating KeystoneJS Forum user...' );
		console.log('------------------------------------------------------------');
		...
		console.log('[services.facebook] - KeystoneJS Forum user create data:', userData );
		
		// Create user
		data.sydjsUser = new User.model(userData);
		
		console.log('[services.facebook] - Created new instance of KeystoneJS Forum user.' );
		console.log('------------------------------------------------------------');
	...
	var saveSydjsUser = function() {
		...
		console.log('[services.facebook] - Saving KeystoneJS Forum user...' );
		console.log('------------------------------------------------------------');
		...
		console.log('[services.facebook] - KeystoneJS Forum user update data:', userData );
		...
		data.sydjsUser.save(function(err) {
			...
			if (err) {
				console.log(err);
				console.log("[services.facebook] - Error saving KeystoneJS Forum user.");
				console.log('------------------------------------------------------------');
				return callback(err);
				
			} else {
				
				console.log("[services.facebook] - Saved KeystoneJS Forum user.");
				console.log('------------------------------------------------------------');
	...
	var signinSydjsUser = function() {
		...
		console.log('[services.facebook] - Signing in KeystoneJS Forum user...');
		console.log('------------------------------------------------------------');
