...
exports.authenticateUser = function(req, res, next, callback)
{
	...
	var data = {
		...
		sydjsUser: false // Keystone Forum user
	}
	...
	// Function to create Keystone Forum user
	var createSydjsUser = function() {
		
		console.log('[services.facebook] - Creating Keystone Forum user...' );
		console.log('------------------------------------------------------------');
		...
		console.log('[services.facebook] - Keystone Forum user create data:', userData );
		
		// Create user
		data.sydjsUser = new User.model(userData);
		
		console.log('[services.facebook] - Created new instance of Keystone Forum user.' );
		console.log('------------------------------------------------------------');
	...
	// Function to save Keystone Forum user
	var saveSydjsUser = function() {
		
		// Save the Keystone Forum user data
		console.log('[services.facebook] - Saving Keystone Forum user...' );
		console.log('------------------------------------------------------------');
		...
		console.log('[services.facebook] - Keystone Forum user update data:', userData );
		...
		data.sydjsUser.save(function(err) {
			...
			if (err) {
				console.log(err);
				console.log("[services.facebook] - Error saving Keystone Forum user.");
				console.log('------------------------------------------------------------');
				return callback(err);
				
			} else {
				
				console.log("[services.facebook] - Saved Keystone Forum user.");
				console.log('------------------------------------------------------------');
	...
	// Function to sign in Keystone Forum user
	var signinSydjsUser = function() {
	
		console.log('[services.facebook] - Signing in Keystone Forum user...');
		console.log('------------------------------------------------------------');
