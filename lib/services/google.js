...
var credentials = {
	...
	callbackURL: production ? 'http://forum.keystoneJS.com/authentication/google?callback' : 'http://local.host:3000/authentication/google?callback'
};
...
exports.authenticateUser = function(req, res, next, callback)
{
	...
	var processFBUser = function(googleUser) {
