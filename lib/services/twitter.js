...
exports.authenticateUser = function(req, res, next, callback)
{
	...
	var createSydjsUser = function() {
		...
		console.log('[services.twitter] - Creating Keystone Forum user...');
		console.log('------------------------------------------------------------');
		...
		console.log('[services.twitter] - Keystone Forum user create data:', userData );
		
		// Create user
		data.sydjsUser = new User.model(userData);
		
		console.log('[services.twitter] - Created new instance of Keystone Forum user.');
		console.log('------------------------------------------------------------');
	...
	var saveSydjsUser = function() {
		...
		console.log('[services.twitter] - Saving Keystone Forum user...');
		console.log('------------------------------------------------------------');
		...
		console.log('[services.twitter] - Keystone Forum user update data:', userData );
		...
		data.sydjsUser.save(function(err) {
			...
			if (err) {
				console.log(err);
				console.log("[services.twitter] - Error saving Keystone Forum user.");
				console.log('------------------------------------------------------------');
				return callback(err);
				
			} else {
				
				console.log("[services.twitter] - Saved Keystone Forum user.");
				console.log('------------------------------------------------------------');
	...
	var signinSydjsUser = function() {
		...
		console.log('[services.twitter] - Signing in Keystone Forum user...');
		console.log('------------------------------------------------------------');
